...
public class ExposeImpl extends InstructionImpl implements Expose {
	...
	protected EClass eStaticClass() {
		return DockermetamodelPackage.Literals.EXPOSE;
	}
	...
	public EList<Argument> getArgument() {
		if (argument == null) {
			argument = new EObjectContainmentEList<Argument>(Argument.class, this, DockermetamodelPackage.EXPOSE__ARGUMENT);
		}
		return argument;
	}
