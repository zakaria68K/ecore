 ...
 * @generated
 */
public class DockermetamodelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DockermetamodelPackage.ARGUMENT: {
				Argument argument = (Argument)theEObject;
				T result = caseArgument(argument);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DockermetamodelPackage.OPTION: {
				Option option = (Option)theEObject;
				T result = caseOption(option);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DockermetamodelPackage.INSTRUCTION: {
				Instruction instruction = (Instruction)theEObject;
				T result = caseInstruction(instruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DockermetamodelPackage.FROM: {
			...
			case DockermetamodelPackage.DOCKERFILE: {
				Dockerfile dockerfile = (Dockerfile)theEObject;
				T result = caseDockerfile(dockerfile);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DockermetamodelPackage.COMMENT: {
				Comment comment = (Comment)theEObject;
				T result = caseComment(comment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DockermetamodelPackage.COPY: {
				Copy copy = (Copy)theEObject;
				T result = caseCopy(copy);
				if (result == null) result = caseInstruction(copy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DockermetamodelPackage.RUN: {
			...
			case DockermetamodelPackage.WORKDIR: {
			...
			case DockermetamodelPackage.CMD: {
			...
			case DockermetamodelPackage.EXPOSE: {
