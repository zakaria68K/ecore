...
/**
 * This is the item provider adapter for a {@link projectsortie.config} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class configItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProjectsortiePackage.Literals.CONFIG__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProjectsortiePackage.Literals.CONFIG__AGENT);
			childrenFeatures.add(ProjectsortiePackage.Literals.CONFIG__STAGES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ProjectsortiePackage.Literals.CONFIG__AGENT,
				 ProjectsortieFactory.eINSTANCE.createAgent()));

		newChildDescriptors.add
			(createChildParameter
				(ProjectsortiePackage.Literals.CONFIG__STAGES,
				 ProjectsortieFactory.eINSTANCE.createStages()));
	}
