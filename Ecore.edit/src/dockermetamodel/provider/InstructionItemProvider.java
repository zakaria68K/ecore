...
public class InstructionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DockermetamodelPackage.Literals.INSTRUCTION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DockermetamodelPackage.Literals.INSTRUCTION__OPTION);
			childrenFeatures.add(DockermetamodelPackage.Literals.INSTRUCTION__COMMENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DockermetamodelPackage.Literals.INSTRUCTION__OPTION,
				 DockermetamodelFactory.eINSTANCE.createOption()));

		newChildDescriptors.add
			(createChildParameter
				(DockermetamodelPackage.Literals.INSTRUCTION__COMMENT,
				 DockermetamodelFactory.eINSTANCE.createComment()));
	}
