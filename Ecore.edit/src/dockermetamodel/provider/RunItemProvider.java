...
public class RunItemProvider extends InstructionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DockermetamodelPackage.Literals.RUN__ARGUMENT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Run.class)) {
			case DockermetamodelPackage.RUN__ARGUMENT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DockermetamodelPackage.Literals.RUN__ARGUMENT,
