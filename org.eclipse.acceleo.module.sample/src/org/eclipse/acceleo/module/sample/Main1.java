...
/**
 * Entry point of the 'Main1' generation module.
 *
 * @generated
 */
public class Main1 extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/acceleo/module/sample/main1";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "main1config" };
     ...
     * @generated
     */
    public Main1(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Main1(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Main1 generator = new Main1(modelURI, folder, arguments);
